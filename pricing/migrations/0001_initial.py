    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.TextField(max_length=64, verbose_name='Наименование')),
                ('logo', models.FileField(help_text='Требуемый формат - *.svg', upload_to='svg_logos/', validators=[pricing.validators.validate_svg], verbose_name='Логотип')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(max_length=64, verbose_name='Наименование')),
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='models', to='pricing.brand', verbose_name='Брэнд')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(max_length=128, verbose_name='Наименование')),
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='RUB', max_digits=8, null=True, verbose_name='Стоимость')),
                ('model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='services', to='pricing.devicemodel', verbose_name='Модель устройства')),
            ],
            options={
                'verbose_name': 'Услуга',
